<template>
    <div class="flex items-center w-full mx-auto" >
        ...
        <input
            ...
            type="text"
            placeholder="Поиск"
            class="w-full font-regular ps-10 bg-kpnpale border-kpnpale rounded-xl border-1 text-md duration-300 text-slate-900 hover:bg-white hover:ring-orange-500 hover:ring-1 focus:bg-white focus:ring-orange-500 focus:border-orange-500"
        />
    </div>
